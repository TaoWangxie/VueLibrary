...
import { getToken, doLoginOut } from "@/utils/micro"
...
export const responseHandler = function (
  data: any,
  resolve: any,
  reject: any,
  metadata: any
...
export const fetch = <E, O>(
  url: string,
  ...rest: [type?: string, headers?: any, responseType?: string]
) => api<E, O>(url, ...rest)

fetch.GET = <E, O>(url: string, headers?: any) =>
  api<E, apiType<O>>(url, "GET", headers)
fetch.POST = <E, O>(url: string, headers?: any) =>
  api<E, apiType<O>>(url, "POST", headers)
fetch.PUT = <E, O>(url: string, headers?: any) =>
  api<E, apiType<O>>(url, "PUT", headers)
fetch.DELETE = <E, O>(url: string, headers?: any) =>
  api<E, apiType<O>>(url, "DELETE", headers)
